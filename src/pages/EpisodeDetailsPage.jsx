...
const EpisodeDetailsPage = () => {
    ...
    const { fetchPodcastDetails, getEpisodeDetails, findPodcast } = usePodcastStore();
    ...
    const { trackName, description, artworkUrl600, releaseDate, trackTimeMillis, previewUrl } = episodeDetails;
        ...
        <Container maxW="container.xl" p={5}>
            <Flex direction={{ base: 'column', md: 'row' }} gap={10}>
                ...
                >
                    ...
                    <Text fontSize="sm" color="gray.500">{new Date(releaseDate).toLocaleDateString()}</Text>
                    <Text>{trackTimeMillis ? `${(trackTimeMillis / 60000).toFixed(0)} min` : 'N/A'}</Text>
                    <Box
